 ...
 * @description
 */
public class AddFilter extends GeneralFilter{
	private ArrayList<String> shouldAddSubjects = new ArrayList<String>();
	
	public AddFilter(ArrayList<String> subjects) {
		this.shouldAddSubjects = (ArrayList<String>) subjects.clone();
	}
